...
var send = function () {
    ...
    if (msg == '' || $.cookie("service") == '') {
        ...
        var str = '';
        str += '<li class="chatmsg"><div class="showtime">' + time + '</div>';
        str += '<div class="" style="position: absolute;top: 26px;right: 2px;"><img  class="my-circle cu_pic" src="./file/avatar-red2.png" width="40px" height="40px"></div>';
        str += "<div class='outer-right'><div class='customer'>";
        str += "<pre>" + msg2 + "</pre>";
        str += "</div></div>";
        str += "</li>";
        ...
        const avatarUrl = ''
        const replyFunc = (content = '') => {
            let msg = ''
            msg += '<li class="chatmsg"><div style="position: absolute;left:3px;">';
            msg += '<img class="my-circle  se_pic" src="./file/service/1692000969.png" width="40px" height="40px"></div>';
            msg += "<div class='outer-left'><div class='service'>";
            msg += "<pre>" + content + "</pre>";
            msg += "</div></div>";
            msg += "</li>";
